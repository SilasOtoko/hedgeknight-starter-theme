...
// Register Widget
function hedge_knight_widgets_init() {
  register_sidebar( array(
    'name'          => __( 'Blog Sidebar', 'hedge_knight' ),
    'id'            => 'sidebar-1',
    'description'   => __( 'Add widgets here to appear in your sidebar on blog posts and archive pages.', 'hedge_knight' ),
...
add_action( 'widgets_init', 'hedge_knight_widgets_init' );
