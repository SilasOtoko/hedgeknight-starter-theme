...
<head>
   ...
   <?php if ( is_single() ) wp_enqueue_script( 'comment-reply' ); ?> <!-- Needed for some reason -->
...
<body <?php body_class(); ?> id="page-top">
	<a class="skip-main screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'hedgeknight' ); ?></a>
